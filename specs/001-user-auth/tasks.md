...
-   [x] **T-003** — Scaffold the React + TypeScript frontend
    
    -   `npm create vite@latest client -- --template react-ts`
    -   Add `react-router-dom`, `axios`
    -   Creates: `client/`
-   [x] **T-004** — Configure environment variables
...
-   [x] **T-005** — Implement `Result<T>` unified response wrapper
...
-   [x] **T-006** — Implement `ValidationBehavior` pipeline behavior
...
-   [x] **T-010** — Implement `FamilyAccount` entity
...
-   [x] **T-015** — Generate and apply initial EF Core migration
...
-   [x] **T-018** — Implement `RegisterCommand` handler
...
-   [x] **T-019** — Implement `LoginCommand` handler
...
-   [x] **T-022** — Implement `RequestPasswordResetCommand` handler
...
-   [x] **T-023** — Implement `ResetPasswordCommand` handler
...
-   [x] **T-024** — Implement `AuthController`
...
-   [x] **T-025** — Implement `GetProfilesQuery` handler
...
-   [x] **T-026** — Implement `CreateProfileCommand` handler
...
-   [x] **T-027** — Implement `UpdateProfileCommand` handler
...
-   [x] **T-028** — Implement `DeleteProfileCommand` handler
...
-   [x] **T-029** — Implement `ProfilesController`
...
-   [x] **T-030** — Implement `SetPinCommand` handler
...
-   [x] **T-031** — Implement `VerifyPinCommand` handler
...
-   [x] **T-032** — Implement `DeletePinCommand` handler
...
-   [x] **T-033** — Implement `AccountController`
...
-   [x] **T-034** — Unit test: `RegisterCommand` — valid input, duplicate email, weak password
    
    -   Creates: `server/tests/Unit/Auth/RegisterCommandTests.cs`
-   [x] **T-035** — Unit test: `LoginCommand` — valid credentials, wrong password, missing fields
    
    -   Creates: `server/tests/Unit/Auth/LoginCommandTests.cs`
-   [x] **T-036** — Unit test: `RefreshTokenQuery` — valid token, expired token, revoked token
    
    -   Creates: `server/tests/Unit/Auth/RefreshTokenQueryTests.cs`
-   [x] **T-037** — Unit test: `CreateProfileCommand` — valid, age out of range, over limit
    
    -   Creates: `server/tests/Unit/Profiles/CreateProfileCommandTests.cs`
-   [x] **T-038** — Unit test: `UpdateProfileCommand` — valid, wrong account (403), not found (404)
    
    -   Creates: `server/tests/Unit/Profiles/UpdateProfileCommandTests.cs`
-   [x] **T-039** — Unit test: `DeleteProfileCommand` — valid, wrong account (403), not found (404)
    
    -   Creates: `server/tests/Unit/Profiles/DeleteProfileCommandTests.cs`
-   [x] **T-040** — Unit test: `VerifyPinCommand` — correct PIN, wrong PIN, lockout at 5 failures
    
    -   Creates: `server/tests/Unit/Account/VerifyPinCommandTests.cs`
-   [x] **T-041** — Integration test: full register → create profile → profile select flow
...
-   [x] **T-042** — Integration test: persistent session (refresh token rotation)
